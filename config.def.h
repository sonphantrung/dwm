...
static const char *fonts[]          = { "mono:size=10", "Joypixels:size:10:antialias=true:autohint=true" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-p", "Run:", "-h", "10", "-l", "10", NULL };
